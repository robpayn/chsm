...
/**
 * Basic implementation of a holon based on a state value. 
 * This implementation of a holon is a state value, where the
 * value is a map of states at the next lower tier in the hierarchy.  
 * This relationship provides the foundation of the composition hierarchy.
 * 
 * @author robpayn
 *
 */
public class HolonStateValue extends StateValue implements Holon {
    ...
    * @throws Exception 
    */
   public HolonStateValue(String name, Holon parentHolon) throws Exception 
   {
      super(name);
      if (parentHolon != null)
      {
